...
window.LANG_fr = {
    ...
    actor_hint: 'Saisissez un nom, choisissez l\'ID émetteur et l\'EEP, puis envoyez le télégramme d\'apprentissage pour que l\'appareil apprenne cette passerelle. (l\'actionneur doit d\'abord être en mode enseignement) (le récepteur doit d\'abord être en mode enseignement) Démarrer l\'enseignement, puis déclencher l\'appareil à ajouter : appuyez sur son bouton d\'enseignement (ou utilisez simplement un interrupteur normal, par ex. un rocker F6 - il n\'a pas besoin de bouton d\'enseignement). L\'appareil est ajouté automatiquement. Les appareils utilisant un télégramme d\'apprentissage 4BS ou UTE sont reconnus avec leur EEP ; les appareils bidirectionnels sont confirmés.',    bidir_hint: 'Démarrer l\'enseignement, puis déclencher l\'appareil. À la réception, nous répondons avec un télégramme d\'apprentissage depuis le prochain ID émetteur libre et pré-remplissons les détails ci-dessous.',
